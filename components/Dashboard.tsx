                      ...
                      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 18 }}>
                        <div style={{ flex: 1 }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 10 }}>
                            ...
                            {isCreator && (
                              <span style={{ fontSize: 12, background: 'rgba(255,255,255,0.1)', color: '#ffffff', padding: '2px 8px', borderRadius: 3, letterSpacing: 1 }}>
                                OWNER
                              </span>
                            )}
                            {isJoined && !isCreator && (
                              <span style={{ fontSize: 12, background: 'rgba(255,255,255,0.06)', color: '#aaaaaa', padding: '2px 8px', borderRadius: 3, letterSpacing: 1 }}>
                                JOINED
                              </span>
                            )}
                          </div>
                          {project.description && (
                            <p style={{ margin: '0 0 14px', fontSize: 17, color: '#888', lineHeight: 1.6 }}>
                              {project.description}
                            </p>
                          )}
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                    <div style={{ position: 'relative' }}>
                      ...
                      <div style={{
                        ...
                        background: member.is_online ? '#ffffff' : '#333333',
